...
export default function PanelError({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] p-4">
      <div className="glass rounded-2xl p-6 border border-red-500/20 max-w-lg w-full">
        ...
        <div className="bg-black/40 rounded-xl p-4 mb-4 border border-red-500/10">
          <p className="text-xs font-mono text-red-300 break-all">{details}</p>
        </div>
